'use client';
import { ConnectKitProvider as LConnectKitProvider } from 'connectkit';
    ...
    return (
        <LConnectKitProvider
            customTheme={{
                ...
                '--ck-connectbutton-border-color': '#fff',
                '--ck-connectbutton-color': '#ffffff',
                '--ck-connectbutton-background': 'rgb(17,17,17)',
                '--ck-connectbutton-box-shadow':
                    'inset 0 0 0 1px rgba(255, 255, 255, 0.05)',
                '--ck-connectbutton-hover-background': 'rgb(17,17,17)',
                '--ck-connectbutton-active-background': 'rgb(17,17,17)',
                '--ck-connectbutton-balance-color': '#ffffff',
                '--ck-connectbutton-balance-background': 'rgb(17,17,17)',
                '--ck-connectbutton-balance-box-shadow':
                    'inset 0 0 0 1px rgb(17,17,17)',
                '--ck-connectbutton-balance-hover-background': 'rgb(17,17,17)',
                '--ck-connectbutton-balance-active-background': 'rgb(17,17,17)',
                '--ck-primary-button-border-radius': '8px',
                '--ck-primary-button-color': '#ffffff',
                '--ck-primary-button-background': 'rgb(148, 148, 255)',
                '--ck-primary-button-box-shadow':
                    'inset 0 0 0 1px rgba(255, 255, 255, 0)',
                '--ck-primary-button-hover-background':
                    'rgba(148, 148, 255, 0.8)',
                '--ck-secondary-button-border-radius': '8px',
                '--ck-secondary-button-color': '#ffffff',
                '--ck-secondary-button-background': 'rgba(148, 148, 255, 1)',
                '--ck-secondary-button-box-shadow':
                    'inset 0 0 0 1px rgba(255, 255, 255, 0)',
                '--ck-secondary-button-hover-background':
                    'rgba(148, 148, 255, 0.8)',
                '--ck-overlay-background': 'rgba(0,0,0,0.4)',
                '--ck-modal-box-shadow': `inset 0 0 0 1px #38393C, 0px 2px 4px rgba(0, 0, 0, 0)`,
                '--ck-focus-color': '#1A88F8',
                '--ck-body-color': '#ffffff',
                '--ck-body-color-muted': '#8B8F97',
                '--ck-body-color-muted-hover': '#ffffff',
                '--ck-body-background': 'rgb(17,17,17)',
                '--ck-body-background-transparent': 'rgba(31, 32, 35, 0)',
                '--ck-body-background-secondary': 'rgb(17,17,17)',
                ...
                '--ck-dropdown-background': 'rgb(17,17,17)',
                ...
                '--ck-qr-border-color': 'rgba(255,255,255,0)',
                '--ck-recent-badge-border-radius': '32px',
                '--ck-recent-badge-background': 'transparent',
                '--ck-recent-badge-color': '#fff',
            }}
        >
            {children}
        </LConnectKitProvider>
