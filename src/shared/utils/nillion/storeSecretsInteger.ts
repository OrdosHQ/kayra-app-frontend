...
export async function storeSecretsInteger(
    ...
    try {
        ...
        for (const secret of secretsToStore) {
            ...
            const newSecret = nillion.Secret.new_integer(
        ...
        console.log(
            'user ids given update permissions:',
        ...
        console.log(
            'user ids given delete permissions:',
